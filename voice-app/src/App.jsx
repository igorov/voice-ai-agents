...
function App() {
  ...
  const startMic = async () => {
    ...
    processor.onaudioprocess = (e) => {
      if (!micActiveRef.current || !wsRef.current) return
      ...
      if (speaking) {
        ...
        if (!isSpeakingRef.current) {
          ...
          // Interrupt AI if it's responding
        ...
        // Silence just started after speech — start timer
    ...
    setMicActive(true)
    log('Micrófono activado — habla cuando quieras')
  }
  ...
  const micLabel = micActive
    ? userSpeaking
      ? 'Escuchando...'
      : aiSpeaking
        ? 'IA respondiendo (habla para interrumpir)'
        : 'Micrófono activo'
    : 'Activar micrófono'
  ...
  return (
    <div className="container">
      ...
      <p className="muted">
        Conversación en tiempo real. Habla cuando quieras, la IA responde al
        detectar silencio. Puedes interrumpirla hablando.
      </p>
